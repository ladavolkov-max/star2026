...
class TrialBatch:
    ...
    def runBatch(self):
        ...
        for trial in range(self.__numTrials): 
            ...
            decisions.append(f"TRIAL {trial + 1}--------------------------")
            ...
            for step in range(self.__numSteps): 
                ...
                dominantSensor = "vision" if confidenceVision > confidenceSpatial else "spatial"
                decisionDescription = f"vision: {inputVision}/{confidenceVision}; spatial: {inputSpatial}/{confidenceSpatial}; decision: {dominantSensor}"
                decisions.append(decisionDescription)
                print(decisionDescription)
                try:
