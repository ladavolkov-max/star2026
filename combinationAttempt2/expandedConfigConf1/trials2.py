...
class TrialBatch:
    ...
    def runBatch(self):
        ...
        for trial in range(self.__numTrials): 
            ...
            for step in range(self.__numSteps): 
                ...
                inputSymbol = self.getDecisionScenario(responseVision, responseSpatial)
                inputString = f"{inputSymbol}/1\n"
                try:
    ...
    def getDecisionScenario(self, visionResponse, spatialResponse):
        wordsToNum = {
            "vision0spatial0" : 1,
            "vision0spatial1" : 2,
            "vision0spatial2" : 3,
