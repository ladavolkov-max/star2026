...
if __name__ == "__main__":
    ...
    for i in range(numBatchesToRun):
        ...
        visionPretrainingFilePath = os.path.join(visionPretrainingDir, f"visionPretrainingResults{i}.txt")
        spatialPretrainingFilePath = os.path.join(spatialPretrainingDir, f"spatialPretrainingResults{i}.txt")
        combinationResultsFilePath = os.path.join(combinationResultsDir, f"batch{i}.txt")
