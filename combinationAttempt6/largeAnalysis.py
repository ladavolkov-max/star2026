...
if __name__ == "__main__":
    ...
    for i in range(numBatchesToRun):
        ...
        visionPretrainingFilePath = os.path.join(visionPretrainingDir, f"visionPretrainingResults{i + 8}.txt")
        spatialPretrainingFilePath = os.path.join(spatialPretrainingDir, f"spatialPretrainingResults{i + 8}.txt")
        combinationResultsFilePath = os.path.join(combinationResultsDir, f"batch{i + 8}.txt")
