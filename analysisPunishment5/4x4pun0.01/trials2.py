...
class TrialBatch:
    ...
    def __init__(self,
        ...
        if platform.system() == "Windows":
            self.__caPath = os.path.join(self.__scriptDir, "caMacosNewpun.exe") #path of the CA executable
        else:
            self.__caPath = os.path.join(self.__scriptDir, "caMacosNewpun") #path of the CA executable
            ...
            for step in range(self.__numSteps): 
                ...
                if response == b'0': #do nothing
                    ...
                    if canMove:
                        ...
                        self.__pid.stdin.write(b"22/0.01\n")
