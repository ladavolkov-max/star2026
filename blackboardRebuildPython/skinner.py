...
pid = Popen(["/Users/ladavolkov/Desktop/ca", "/Users/ladavolkov/Desktop/skinnerVision.cfg"], stdin=PIPE, stdout=PIPE, bufsize=0)
...
for i in range(300):
	...
	pid.stdout.readline()
	print (i, j)
	#print("Trial # " + (str)(i+1) + " finished in " + (str)(j+1) + " steps.")
