...
class Grid extends JComponent implements KeyListener
{
    ...
    private OneTrialGrid3x3ForG bot;
    ...
    {
        //(loc-1) % 3 = how many columns across (bc want zero indexing here)
        xOffset = ((loc - 1) % 3) * size;
        //(loc-1) / 3 = how many rows down (bc want zero indexing here)
        yOffset = ((loc - 1) / 3) * size;
    ...
    public void paint(Graphics g)
    {
        ...
        g2.drawRect(startX + size * colCount - 10, startY + size * rowCount - 50, 10, 40);
        ...
        if(see == 1)
        {
            g2.drawString("see: corner FL", 50, 65);
        }
        else if(see == 2)
        {
            g2.drawString("see: corner FR", 50, 65);
        }
        else if(see == 3)
        {
            g2.drawString("see: wall L", 50, 65);
        }
        else if(see == 4)
        {
            g2.drawString("see: wall R", 50, 65);
        }
        else if(see == 5)
        {
            g2.drawString("see: wall F", 50, 65);
        }
        else if(see == 6)
        {
            g2.drawString("see: none", 50, 65);
        }
        else if(see == 7)
        {
            g2.drawString("see: bar L", 50, 65);
        }
        else if(see == 8)
        {
            g2.drawString("see: bar R", 50, 65);
        }
        else if(see == 8)
        {
            g2.drawString("see: bar F", 50, 65);
        }
        else
        {
            g2.drawString("see: --", 50, 65);
        }
        g2.drawString("loc: " + loc, 50, 80);
