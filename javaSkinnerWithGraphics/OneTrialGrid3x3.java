...
public class OneTrialGrid3x3
{
    ...
    public OneTrialGrid3x3() throws IOException
    {
    ...
    public void runOneTrial() throws IOException
    {
        ...
        for(j = 0; j < 50; j++)
        {
            ...
            //printing
            System.out.println("Gonna take step " + (j + 1));
            System.out.println("Currently at loc " + loc + " w dir " + dir);
            System.out.println("Currently see " + visualSymbol);
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        OneTrialGrid3x3 bot = new OneTrialGrid3x3();
