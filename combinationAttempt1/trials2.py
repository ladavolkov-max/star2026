    ...
    def runBatch(self):
        ...
        for trial in range(self.__numTrials): 
            ...
            for step in range(self.__numSteps): 
                ...
                inputString = f"{responseVision}/{confidenceVision} {responseSpatial}/{confidenceSpatial}\n"
                try:
                ...
                print(f"vision says do: {responseVision}")
                print(f"spatial says do: {responseSpatial}")
                ...
                if response == b'0': #do nothing
                    ...
                    if (self.__locX == self.__locBarX and
                        ...
                        self.__pidDecision.stdin.write(b"?????????/1\n")
