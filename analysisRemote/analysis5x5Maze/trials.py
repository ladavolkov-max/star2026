...
class TrialBatch:
    ...
    def __init__(self,
        ...
        self.__caPath = self.__scriptDir / "ca" #path of the CA executable
        self.__cfgPath = self.__scriptDir / "skinnerVisionMaze.cfg" #path of the configuration file
        self.__pid = Popen(["/home/bls96/bin/ca", self.__cfgPath], stdin=PIPE, stdout=PIPE, bufsize=0) #starting up the ca process
