...
scenarioName = ""
dataFiles = []
dirPath = "/Users/lenas/Desktop/analysisPunishment4/3x3MazeSpatial/spatialInversePun0.1/data/nonPunishedProportions"
lastBatchNum = 40
for i in range(1, lastBatchNum + 1):
...
for filePath in dataFiles:
    ...
    ax.scatter(xVals, yVals, s=12, color='blue', alpha=0.7)
